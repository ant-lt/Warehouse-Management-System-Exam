...
namespace WMS.Infastructure.Migrations
{
    ...
    [Migration("20230116120032_Pridetas Inventories FK į Orders")]
    partial class PridetasInventoriesFKįOrders
    {
            ...
            modelBuilder.Entity("WMS.Domain.Models.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Country = "Lietuva",
                            Created = new DateTime(2023, 1, 16, 14, 0, 31, 416, DateTimeKind.Local).AddTicks(2604),
                            Email = "test@test.com",
                            LegalCode = "123456789",
                            Name = "UAB Bandymas",
