...
namespace WMS.Infastructure.Migrations
{
    ...
    [Migration("20230114165807_Pridetas navigation property Warehouse ir Products")]
    partial class PridetasnavigationpropertyWarehouseirProducts
    {
            ...
            modelBuilder.Entity("WMS.Domain.Models.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Country = "Lietuva",
                            Created = new DateTime(2023, 1, 14, 18, 58, 6, 578, DateTimeKind.Local).AddTicks(9175),
                            Email = "test@test.com",
                            LegalCode = "123456789",
                            Name = "UAB Bandymas",
